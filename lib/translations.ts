      ...
      entries: [
        {
          ...
          text: 'Working with him on the Now or Never Magazine website was super smooth. I had a clear vision, and he translated it into a clean, modern site that really fits the magazine’s identity. Communication was easy, changes were fast, and the end result honestly exceeded my expectations.',
          stars: 5,
        },
        {
          name: 'Kare & Tun',
          role: 'Restuarant owner',
          text: 'He built our restaurant website exactly the way we needed it — clean, inviting, and easy for customers to find us online. Since launching it, we’ve seen more people discovering our restaurant and checking us out before visiting. The whole process was smooth, and he really understood what we wanted.',
          stars: 5,
        },
        {
          name: 'Vatchanan',
          role: 'Real Estate Business Owner',
          text: 'I was extremely happy with the results. After launching my website and marketing setup, I started receiving consistent, high-quality leads for my real estate business. Everything was handled professionally, communication was clear, and I felt supported the whole way. I would absolutely recommend him to any business owner who wants real results.',
          stars: 5,
        },
      ],
    },
